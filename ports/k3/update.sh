...
held_packages=aquamarine,hyprland,xdg-desktop-portal-hyprland,hyprutils,hyprgraphics,hyprcursor,hyprlang,hyprwire,neatvnc
sudo pacman -Syu --ignore "$held_packages"
echo "Arch RISC-V package update complete. The patched compositor libraries remain pinned pending a coordinated rebuild."
